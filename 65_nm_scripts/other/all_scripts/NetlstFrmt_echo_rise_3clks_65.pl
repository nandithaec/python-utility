...
#Example: perl NetlstFrmt_echo_rise_3clks_65.pl -v decoder_op_ip_modelsim.v -s pnr/op_data/decoder_op_ip_final_new.dspf -c 400 -t 65 -m decoder_op_ip


#clk frequency in MHz

#Modifications:
#$rise_to_2nd is made 2.49*clk period + 50ps. Fall to is made + 50ps: : Mar 20 2014
#.ic is added for 65nm.: Mar 20 2014
#.GLOBAL vdd,gnd and Vgnd,Rgnd added to make the 65nm decks run: Mar 20 2014
...
print SIM ".include  ../glitch_CORE65GPSVT_selected_lib_RC.sp"."\n";
