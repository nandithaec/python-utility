...
f = open('%s/spice_results/final_results_spice_outputs_time0_%d.csv' %(path,int(outloop)), 'rb')
frtl = open('%s/%s_reference_out/RTL_time0_%d.csv' %(path,module,int(outloop)), 'rb')
fout = open('%s/spice_results/spice_rtl_difference_time0_%d.csv' %(path,int(outloop)), 'wb')
...
fd = open('%s/spice_results/spice_rtl_difference_time0_%d.csv' %(path,int(outloop)), 'rb') #Open in read mode
fv = open('%s/spice_results/spice_rtl_diff_testing_time0_%d.csv' %(path,int(outloop)), 'wb')
...
fd = open('%s/spice_results/spice_rtl_difference_time0_%d.csv' %(path,int(outloop)), 'rb') 
diff_file = csv.reader(fd)
...
#shutil.copytree('%s/spice_decks' %path, '%s/backup_spice_decks_time0/spice_%d' %(path,loop),symlinks=False, ignore=None)
#Save decks in which > 4 flips occured
if len(more_than4_flips) != 0 :
	
	len_morethan4=len(more_than4_flips)
	if not os.path.exists('%s/backup_spice_decks_time0/four_flip' %(path)):
		os.mkdir('%s/backup_spice_decks_time0/four_flip' %(path))
	for i in (range(0,len_morethan4)):
		if os.path.isfile('%s/spice_decks_%d/deck_%d.sp' %(path,loop,more_than4_flips[i])):
			shutil.copy('%s/spice_decks_%d/deck_%d.sp' %(path,loop,more_than4_flips[i]), '%s/backup_spice_decks_time0/four_flip' %(path))
			#shutil.copy('%s/spice_decks_%d/glitch_report_outputs_%d.csv' %(path,loop,more_than4_flips[i]), '%s/backup_spice_decks_time0/four_flip' %(path))
		if os.path.isfile('%s/spice_decks_%d/hspice_deck_%d.sp' %(path,loop,more_than4_flips[i])):
			shutil.copy('%s/spice_decks_%d/hspice_deck_%d.sp' %(path,loop,more_than4_flips[i]), '%s/backup_spice_decks_time0/four_flip' %(path))
...
if len(four_flips) != 0 :
	...
	for i in (range(0,len4)):
		if os.path.isfile('%s/spice_decks_%d/deck_%d.sp' %(path,loop,four_flips[i])):
			shutil.copy('%s/spice_decks_%d/deck_%d.sp' %(path,loop,four_flips[i]), '%s/backup_spice_decks_time0/four_flip' %(path))
			#shutil.copy('%s/spice_decks_%d/glitch_report_outputs_%d.csv' %(path,loop,four_flips[i]), '%s/backup_spice_decks_time0/four_flip' %(path))
		if os.path.isfile('%s/spice_decks_%d/hspice_deck_%d.sp' %(path,loop,four_flips[i])):
			shutil.copy('%s/spice_decks_%d/hspice_deck_%d.sp' %(path,loop,four_flips[i]), '%s/backup_spice_decks_time0/four_flip' %(path))

#Save decks in which 3 flips occured
if len(three_flips) != 0 :
	
	len3=len(three_flips)
	if not os.path.exists('%s/backup_spice_decks_time0/three_flip' %(path)):
		os.mkdir('%s/backup_spice_decks_time0/three_flip' %(path))
	for i in (range(0,len3)):
		if os.path.isfile('%s/spice_decks_%d/deck_%d.sp' %(path,loop,three_flips[i])):
			shutil.copy('%s/spice_decks_%d/deck_%d.sp' %(path,loop,three_flips[i]), '%s/backup_spice_decks_time0/three_flip' %(path))
			#shutil.copy('%s/spice_decks_%d/glitch_report_outputs_%d.csv' %(path,loop,three_flips[i]), '%s/backup_spice_decks_time0/three_flip' %(path))
		if os.path.isfile('%s/spice_decks_%d/hspice_deck_%d.sp' %(path,loop,three_flips[i])):
			shutil.copy('%s/spice_decks_%d/hspice_deck_%d.sp' %(path,loop,three_flips[i]), '%s/backup_spice_decks_time0/three_flip' %(path))

#Save decks in which 2 flips occured
if len(two_flips) != 0 :
			
	len2=len(two_flips)
	if not os.path.exists('%s/backup_spice_decks_time0/two_flip' %(path)):
		os.mkdir('%s/backup_spice_decks_time0/two_flip' %(path))
	for i in (range(0,len2)):
		if os.path.isfile('%s/spice_decks_%d/deck_%d.sp' %(path,loop,two_flips[i])):
			shutil.copy('%s/spice_decks_%d/deck_%d.sp' %(path,loop,two_flips[i]), '%s/backup_spice_decks_time0/two_flip' %(path))
			#shutil.copy('%s/spice_decks_%d/glitch_report_outputs_%d.csv' %(path,loop,two_flips[i]), '%s/backup_spice_decks_time0/two_flip' %(path))
		if os.path.isfile('%s/spice_decks_%d/hspice_deck_%d.sp' %(path,loop,two_flips[i])):
			shutil.copy('%s/spice_decks_%d/hspice_deck_%d.sp' %(path,loop,two_flips[i]), '%s/backup_spice_decks_time0/two_flip' %(path))
...
if len(one_flip) != 0:
	...
	len1=len(one_flip)
	if not os.path.exists('%s/backup_spice_decks_time0/one_flip' %(path)):
		os.mkdir('%s/backup_spice_decks_time0/one_flip' %(path))
	...
	if os.path.isfile('%s/spice_decks_%d/deck_%d.sp' %(path,loop,one_flip[random_deck])):
		shutil.copy('%s/spice_decks_%d/deck_%d.sp' %(path,loop,one_flip[random_deck]), '%s/backup_spice_decks_time0/one_flip' %(path))
		#shutil.copy('%s/spice_decks_%d/glitch_report_outputs_%d.csv' %(path,loop,one_flip[random_deck]), '%s/backup_spice_decks_time0/one_flip' %(path))
	...
	if os.path.isfile('%s/spice_decks_%d/hspice_deck_%d.sp' %(path,loop,one_flip[random_deck])):
		shutil.copy('%s/spice_decks_%d/hspice_deck_%d.sp' %(path,loop,one_flip[random_deck]), '%s/backup_spice_decks_time0/one_flip' %(path))

#Save decks in which no flip occured
if len(no_flip) != 0:
		
	len0=len(no_flip)
	if not os.path.exists('%s/backup_spice_decks_time0/no_flip' %(path)):
		os.mkdir('%s/backup_spice_decks_time0/no_flip' %(path))
	...
	if os.path.isfile('%s/spice_decks_%d/deck_%d.sp' %(path,loop,no_flip[random_deck])):
		shutil.copy('%s/spice_decks_%d/deck_%d.sp' %(path,loop,no_flip[random_deck]), '%s/backup_spice_decks_time0/no_flip' %(path))
		#shutil.copy('%s/spice_decks_%d/glitch_report_outputs_%d.csv' %(path,loop,no_flip[random_deck]), '%s/backup_spice_decks_time0/no_flip' %(path))
	...
	if os.path.isfile('%s/spice_decks_%d/hspice_deck_%d.sp' %(path,loop,no_flip[random_deck])):
		shutil.copy('%s/spice_decks_%d/hspice_deck_%d.sp' %(path,loop,no_flip[random_deck]), '%s/backup_spice_decks_time0/no_flip' %(path))
