...
#Example usage: python python_GNUparallel_ngspice_yuva_rise_65.py -n 2224 -d c432 -o 1 -p /home/external/iitb/nanditha/simulations/65nm/c432/
...
fw1_rise.close()
print "****Combined all csv files into a single file in the results folder along with the header- for rise****\n"
