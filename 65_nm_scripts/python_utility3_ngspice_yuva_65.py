...
#Example usage: python python_utility3_ngspice_yuva_65.py -m b01 -p /home/users/nanditha/Documents/utility/65nm/b01 -t 65 -n 4 --group 4 --clk 400 -d b01
...
##################Script repeat_deckgen copied ends here####################################
	...
	os.system('python %s/python_GNUparallel_ngspice_yuva_65.py -n %s -d %s -o %s -p %s' %(path,num_at_a_time,design_folder,loop,path))
