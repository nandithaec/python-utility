...
#Example usage: python utility_python_top_level_65.py -p /home/users/nanditha/Documents/utility/65nm/c499 --rtl=/home/users/nanditha/Documents/utility/65nm/c499/c499_clk_ipFF.vhd --mod=c499_clk_ipFF --test=/home/users/nanditha/Documents/utility/65nm/c499/test_c499.v --tb_mod=test_c499 --clk=350 --run=100us --design=c499 --tech=65 --num=10 --group 10 --extl=/home/external/iitb/nanditha/simulations/65nm/c499  --proc_node 1 --ppn 5 --days 00 --hrs 00 --mins 3 --script python_utility3_yuva_2cycles_2nd_3rd_65.py
...
#Example usage: python python1_read_RTL_syn_pnr.py -f c499.vhd -m c499_behav_pnr -clk 900
...
#Example usage: perl perl2_outwrtr.pl -v pnr/op_data/c499_behav_pnr_final.v -m c499_behav_pnr
...
##Example usage: python python3_create_simdo_vsim.py -rtl c499_behav_pnr_modelsim.v -tb test_c499_pnr.vhd -tb_mod t_c499_pnr -time 1us
...
#NetlistFormat.pl
#perl NetlstFrmt.pl -v c499_behav_pnr_modelsim.v -s pnr/op_data/c499_behav_pnr_final.dspf -l glitch_osu018_stdcells_correct_allcells.sp -c 1e9 -t 180 -m c499_behav_pnr
