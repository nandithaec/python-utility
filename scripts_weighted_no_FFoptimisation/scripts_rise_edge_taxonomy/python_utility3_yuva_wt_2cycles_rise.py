...
################################################################################################################
	...
	os.system('python %s/python_GNUparallel_ngspice_yuva_rise.py -n %s -d %s -o %s -p %s' %(path,num_at_a_time,design_folder,loop,path))
	...
	os.system('python %s/python_compare_fall.py -m %s -f %s -n %s -t %s -l %d' %(path,module,path,num_at_a_time,tech,loop))

	print "Comparing the RTL and spice outputs at the 2nd rising edge \n"
	os.system('python %s/python_compare_rise.py -m %s -f %s -n %s -t %s -l %d' %(path,module,path,num_at_a_time,tech,loop))
...
os.system('python  %s/python_count_flips_rise.py -f %s  -n %s  --group %s -s %s' %(path,path,num,num_at_a_time,seed))  #To save the seed to results file
