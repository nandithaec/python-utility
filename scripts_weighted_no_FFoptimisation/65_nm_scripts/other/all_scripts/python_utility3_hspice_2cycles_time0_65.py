...
#Example usage: python python_utility3_hspice_2cycles_time0_65.py -m c1908_clk_opFF -p /home/users/nanditha/Documents/utility/65nm/FF_optimisation/c1908 -t 65 -n 4 --group 4 --clk 500 -d c1908
