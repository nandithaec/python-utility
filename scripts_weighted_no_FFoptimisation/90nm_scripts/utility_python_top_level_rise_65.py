...
#Example usage: python utility_python_top_level_rise_65.py --rtl=/home/users/nanditha/Documents/utility/90nm/c432/c432_clk_ipFF.v --mod=c432_clk_ipFF --test=/home/users/nanditha/Documents/utility/90nm/c432/test_c432.v --tb_mod=test_c432 --clk=250 --run=100us --design=c432 --tech=90 --num=10 --group 10 --path=/home/external/iitb/nanditha/simulations/90nm/c432   --proc_node 1 --ppn 5 --days 00 --hrs 00 --mins 3 --script python_utility3_yuva_3cycles_2nd_3rd_65.py.py

#removed std_lib: mar 25 2014
...
#3 clk cycle simulation being invoked for 90nm since the .ic does not seem to be working in ngspice for 90nm: Mar 17 2014
...
os.system('python python_subckt_line_modify.py -m %s' %(module))
time.sleep(5)
...
os.system('perl GlitchLibGen_65.pl -i faraday_umc90nm_selected_lib.sp' )
...
os.system('perl NetlstFrmt_echo_rise_3clks_90.pl -v %s_modelsim.v  -s pnr/op_data/%s_final_new.dspf  -c %s -t %s -m %s' %(module,module,clkfreq,techn, module))
