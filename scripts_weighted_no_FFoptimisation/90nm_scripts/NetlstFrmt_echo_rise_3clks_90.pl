...
#Example:  perl NetlstFrmt_echo_rise_3clks_90.pl -v c432_clk_ipFF_modelsim.v -s pnr/op_data/c432_clk_ipFF_final_new.dspf -c 250 -t 90 -m c432_clk_ipFF
...
#Modifications:
#k_plus1 changed: for 3 clk cycle simulation: Mar 26 2014
...
#include library and technology files modified as per 90nm, removed $lib option: not needed: Mar 21 2014
...
print SIM ".GLOBAL VCC2V  VCC3V  VCC18V VCC12V VCC1V VCC VCCI  VCCR ","\n";
