...
def weight_selection(path):
	...
	gates=["HS65_GSS_XOR2X6","HS65_GS_AND2X4","HS65_GS_AOI22X6","HS65_GS_BFX284","HS65_GS_DFPQX4", "HS65_GS_IVX9","HS65_GS_NAND2X7","HS65_GS_NOR2X6","HS65_GS_NOR3X4"]

	gate_areas=[4,3,4,30,85,5,6,10,5]
