...
#Example: perl NetlstFrmt_echo_rise_3clks_65.pl -v decoder_op_ip_modelsim.v -s pnr/op_data/decoder_op_ip_final_new.dspf -c 250 -t 90 -m decoder_op_ip


#clk frequency in MHz

#Modifications:
#$rise_to_2nd is made 2.49*clk period + 50ps. Fall to is made + 50ps: : Mar 21 2014
#.ic is added for 90nm: Mar 21 2014
#Global vcc and vgnd rgnd added for 90nm: Mar 21 2014
#include library and technology files modified as per 90nm, re,oved $lib option: not needed: Mar 21 2014
...
sub printErrMessage {
 ...
 print "NetlstFrmt ERROR: BAD SYNTAX\n";
...
print SIM '.include ../glitch_faraday_umc90nm_selected_lib.sp'."\n";
print SIM ".include  ../L90_SP10_V061.mdl"."\n";
...
while(<SPC>)
 {  
  ...
  #raising a flag when the subcircuit line is reached
      if($_=~m/.SUBCKT/)
        {
          $flag_sub =1;
        }
...
$rise_from_2nd=(2.49*$clk_period); #defining rise time window
...
print SIM 'Vgnd AGND 0 0'."\n\n";
print SIM "Vvdd VCC2V 0 2"."\n"."Vvdd1 VCC3V 0 3"."\n\n"."Vvdd2 VCC18V 0 1.8"."\n\n";
print SIM "Vvdd3 VCC12V 0 1.2"."\n"."Vvdd4 VCC1V 0 1"."\n\n"."Vvdd5 VCC 0 1"."\n\n";
print SIM "Vvdd6 VCCI 0 1.2"."\n"."Vvdd7 VCCR 0 1.2"."\n\n";
...
if($i ne "clk")
   {
      ...
      print SIM ".ic v(X$module.$to_ff[$i]:Q)= ##$new\_reference_minus1##\n";
   }
