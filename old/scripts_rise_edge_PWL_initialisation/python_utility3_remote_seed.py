...
#Example usage: python python_utility3_remote_seed.py -m c880_clk -p /home/user1/simulations/c880_alu -d c880_alu -t 180 -n 10 --group 10 --clk 100 --std_lib osu018_stdcells_correct_vdd_gnd.sp
...
#This means, glitch "can" occur before the input changes in the clk period as well. So, force the glitch to start only after input has changed
		...
		unif=random.uniform(0,0.35*clk_period) 
		rand_glitch= (1.15*clk_period) +  unif #arrival_clk + initial_clk should add up to 1.5
