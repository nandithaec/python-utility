#Example: perl NetlstFrmt.pl -v c2670_clk_modelsim.v -s c2670_clk.dspf -l glitch_osu018_stdcells_correct_vdd_gnd.sp -c 100 -t 180 -m c2670_clk
...
-s pnr/op_data/<module>_final.dspf - spice(dspf) output from rtlgds
