#!/usr/bin/perl
#Example usage: perl perl_write_simfile_65.pl -v /home/users/nanditha/Documents/utility/65nm/F0_expt/decoder_65nm/pnr/op_data/decoder_op_ip_final.v -m decoder_op_ip -p /home/users/nanditha/Documents/utility/65nm/F0_expt/decoder_65nm
...
#Writing output of flip flop at negative edge
	...
	print OPT "//*************The inputs of the module are not being written:********************\n";
	push @ffipin,@ipin;
...
#Printing the header (pin names) in the tool reference output header - only outputs of flip-flops
print TOOLREF join(" ",@ffopin);
print TOOLREF "\n";
