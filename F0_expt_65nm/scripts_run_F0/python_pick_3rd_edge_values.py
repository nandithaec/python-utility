...
#Example usage: python python_pick_3rd_edge_values.py -m decoder_op_ip -f /home/users/nanditha/Documents/utility/65nm/F0_expt/decoder_65nm -c 11486
...
print "RTL obtained - 3rd rising edge from this clk cycle:",data
