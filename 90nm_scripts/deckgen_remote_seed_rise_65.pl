#Example: perl deckgen_remote_seed_rise_65.pl -s reference_spice.sp  -r c432_clk_ipFF_reference_out/tool_reference_out.txt -n 1 -m c432_clk_ipFF -f /home/users/nanditha/Documents/utility/90nm/c432 -g 4 -d 1 -c 200 -i 4.91e-09 -o 1 
