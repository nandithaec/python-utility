#Example: perl perl_calculate_drain_65.pl -s reference_spice.sp -r c432_clk_ipFF_reference_out/tool_reference_out.txt -m c432_clk_ipFF -f /home/users/nanditha/Documents/utility/90nm/c432 -g 2
...
if ($#ARGV >= 0 || $ref eq "" || $spc eq ""||  $module eq ""|| $folder eq "" || $rand_gate eq "") {
...
open(LIB1,"glitch_faraday_umc90nm_selected_lib.sp")||die("unable to open file : $!");
