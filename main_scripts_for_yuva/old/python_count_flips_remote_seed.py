...
#Example usage: python python_count_flips_remote_seed.py -f /home/user1/simulations/decoder  -n 100  --group 10 -s 23
...
if (num_of_multiple_flips > 0):
	...
	print('Standard error is: %f\n' %standard_error)
	print('Standard error divided by mean is (sigma/sqrt(N)): %f\n' %std_error_by_mean)
	...
	fflip.write('Standard error is: %f\n' %standard_error)
	fflip.write('Standard error divided by mean is (sigma/sqrt(N)): %f\n' %std_error_by_mean)
