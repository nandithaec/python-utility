...
#Example usage: python python_utility3_remote_seed.py -m c499_clk -p /home/external/iitb/nanditha/simulations/c499_ecat_yuva -d c499_ecat_yuva -t 180 -n 10 --group 10 --clk 125 --std_lib osu018_stdcells_correct_vdd_gnd.sp
...
os.system('cat $PBS_NODEFILE')
print "PBS NODEFILE contents....\n"
time.sleep(10)

os.system('python python_ssh_addr.py -p %s' %(path))
