...
#Example usage: python utility_python_top_level.py --rtl=/home/users/nanditha/Documents/utility/c499_ecat_yuva/c499_clk.v --mod=c499_clk --test=/home/users/nanditha/Documents/utility/c499_ecat_yuva/test_c499.v --tb_mod=test_c499 --clk=125 --run=100us --design=c499_ecat_yuva --tech=180 --num=10 --group 10 --path=/home/external/iitb/nanditha/simulations/c499_ecat  --std_lib osu018_stdcells_correct_vdd_gnd.sp
...
os.system('perl NetlstFrmt.pl -v %s_modelsim.v  -s %s.dspf -l glitch_%s -c %s -t %s -m %s' %(module,module,std_lib,clkfreq,techn, module))
...
os.system('ssh nanditha@yuva.cdac.in python %s/python_utility3_remote_seed.py -n %s -m %s -p %s -d %s -t %s --group %s --clk %s --std_lib %s' %(path_folder,num,module,path_folder,design_folder,techn,group,clkfreq,std_lib))
