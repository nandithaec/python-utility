...
##Example usage:  python python_ssh_addr.py -p /home/nanditha/Documents/utility/trial
...
lines = [line.strip() for line in open('$PBS_NODEFILE')]
new=[]

for r in range(len(lines)):
	#print r
	if r==0: 
		newstring=''.join(["10/nanditha@",lines[0]])		
		new.append(newstring)
	else:
		if(lines[r] != lines[r-1]):
			newstring=''.join(["10/nanditha@",lines[r]])
			new.append(newstring)
