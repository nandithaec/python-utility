...
#Example usage: python %s/python_GNUparallel_ngspice_remote.py -n 10 -d decoder -o 1 -p /home/user1/simulations/decoder
...
parser = OptionParser('Run ngspice parallely on the multiple spice decks on the 48-core cluster machine, using an utility called GNU parallel. sshmachines,txt contains the IP Addresses of the machines to which you want to ssh and run parallel simulations')
