...
NAME
outwrtr - To modify the post PNR verilog file so as to make it capable of writing Flip-flop output to external file
SYNOPSIS

outwrtr [post pnr .v file]  [top module name]

DESCRIPTION

outwrtr utility takes a post PNR verilog file and the top module name of the design as input and creates a verilog file with name as <module_name_modelsim.v> and a reference output file <post_pnr_.v_file_refrence_out> the module_name_modelsim.v is an modified version of the post pnr .v file wchic is capable of writing the outputs to the post_pnr_.v_file_refrence_out every time is is simulated.
OPTIONS
...
This file should be the post pnr .v file of the design.

-m|--m0dule = <name>

This should be the top module name of the design.
...
GlitchLibGen -v|--verilog <post pnr .v file name> -m|--module <module name>
GlitchLibGen -v /home/user/Desktop/design.v -m design
SEE ALSO
SEE ALSO
