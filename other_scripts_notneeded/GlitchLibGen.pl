...
GlitchLibGen utility takes a spice library as input and creates a glitched induced library where eache subciruit has different version, each version has glitch induced to one of its distinct drain excluding Vdd and gnd.
...
GlitchLibGen -i|--input <library name> 
GlitchLibGen -i /home/user/Desktop/osu_lib.sp 
