#Example: perl deckgen_remote_seed_rise.pl -s reference_spice.sp  -r b11_reference_out/tool_reference_out.txt -n 1 -m b11 -f /home/users/nanditha/Documents/utility/b11 -g 4 -d 2 -c 20 -i 4.91e-09 -o 1 
