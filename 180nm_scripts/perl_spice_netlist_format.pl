...
#Example: perl NetlstFrmt_echo_rise.pl -v b03_modelsim.v -s b03.dspf -l glitch_osu018_stdcells_correct_vdd_gnd.sp -c 250 -t 180 -m b03 -p <path>
...
print SIM ".include ../glitch_osu018_stdcells_correct_vdd_gnd.sp\n";
 ...
 {  
   ...
   if(($_=~m/^ *input/)||($_=~m/^ *output/)) #Extracting the input and output from the verilog code
    ...
    if ($qreg==0)
    {
    	...
    	{
    		$qreg=1;
    		print "qreg found value is $qreg"
    	}
    }
