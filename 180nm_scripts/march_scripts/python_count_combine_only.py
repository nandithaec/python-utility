...
#Example usage: python python_count_combine_only.py -m c432_clk_ipFF -p /home/nanditha/Documents/utility/design_cases_taxonomy/c432/3_cycles -d 3_cycles -t 180 -n 4000 --group 1000 --clk 200 --std_lib osu018_stdcells_correct_vdd_gnd.sp
