...
#Example usage: python python1_read_RTL_syn_pnr.py -f /home/users/nanditha/Documents/utility/b03/b03.vhd -m b03 -c 300 -p <path>
...
parser.add_option("-f","--fpath", help='Enter the RTL (verilog or vhdl) file path- THE ENTIRE PATH',dest='filepath')
